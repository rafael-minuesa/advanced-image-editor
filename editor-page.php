    ...
    <div class="aie-container">
        ...
        <div id="aie-editor" class="aie-section aie-editor-section" style="display: none;" role="region" aria-labelledby="editor-heading">
                ...
                <div class="aie-controls-panel" role="group" aria-labelledby="controls-heading">
                    ...
                    <div class="aie-control-group">
                        ...
                        <div class="aie-input-group">
                            <input type="number" id="aie-contrast-input" min="0" max="1" step="0.01" value="0.5" aria-label="<?php esc_attr_e('Contrast value', 'advanced-image-editor'); ?>">
                        ...
                        <div id="contrast-help" class="aie-help-text">
                            <small><?php esc_html_e('Adjust image contrast (0-1)', 'advanced-image-editor'); ?></small>
                        </div>
                    </div>
                    ...
                    <div class="aie-control-group">
                        ...
                        <div class="aie-input-group">
                            <input type="number" id="aie-amount-input" min="0" max="5" step="0.1" value="0.5" aria-label="<?php esc_attr_e('Sharpness amount value', 'advanced-image-editor'); ?>">
                        ...
                        <div id="amount-help" class="aie-help-text">
                            <small><?php esc_html_e('Sharpening intensity (0-5)', 'advanced-image-editor'); ?></small>
                        </div>
                    </div>
                    ...
                    <div class="aie-control-group">
                        ...
                        <div class="aie-input-group">
                            <input type="number" id="aie-radius-input" min="0" max="10" step="0.1" value="1" aria-label="<?php esc_attr_e('Sharpness radius value', 'advanced-image-editor'); ?>">
                        ...
                        <div id="radius-help" class="aie-help-text">
                            <small><?php esc_html_e('Sharpening radius (0-10px)', 'advanced-image-editor'); ?></small>
                        </div>
                    </div>
                    ...
                    <div class="aie-control-group">
                        ...
                        <div class="aie-input-group">
                            <input type="number" id="aie-threshold-input" min="0" max="1" step="0.01" value="0" aria-label="<?php esc_attr_e('Sharpness threshold value', 'advanced-image-editor'); ?>">
                        ...
                        <div id="threshold-help" class="aie-help-text">
                            <small><?php esc_html_e('Sharpening threshold (0-1)', 'advanced-image-editor'); ?></small>
                        </div>
                    </div>
         ...
         <div class="aie-section">
             <h2><?php esc_html_e('How to use the Advanced Image Editor', 'advanced-image-editor'); ?></h2>
             <ol>
                 <li><?php esc_html_e('Click "Select Image" to choose or upload an image.', 'advanced-image-editor'); ?></li>
                 <li><?php esc_html_e('Adjust the sliders or enter a value to apply filters in real-time. Move the comparison slider on the image to preview changes.', 'advanced-image-editor'); ?></li>
                 <li><?php esc_html_e('Click "Save Edited Image" to save a copy to your media library (original image will remain untouched).', 'advanced-image-editor'); ?></li>
             </ol>
